...
- Library definition: `docs/06_libraries/workers/capture_readiness_worker.md`
...
- Library definition: `docs/06_libraries/workers/scheduler_worker.md`
...
- Library definition: `docs/06_libraries/workers/manifest_scheduler_worker.md`
...
- Library definition: `docs/06_libraries/workers/runner_worker.md`
...
- Library definition: `docs/06_libraries/workers/gate_worker.md`
...
- Library definition: `docs/06_libraries/workers/deadline_monitor_worker.md`
...
All workers (except the Deadline Monitor Worker) use the claim/lease protocol defined in `docs/02_mec/flows/polling_workers_v0_1.pseudo.md`.

Required claim fields are specified by `docs/02_mec/schemas/claim_record.schema.json`.
