...
- May read from other azollas' substrates through the inter-azolla query interface defined in `docs/04_taxonomy/inter_azolla_protocol.md`.
...
- **Common schemas** from `docs/02_mec/schemas/`.
- **Workers** selected from `docs/06_libraries/workers/`.
- **Diazotroph types** selected from `docs/06_libraries/diazotroph_types/`.
...
spec:              docs/05_task_mgmt_azolla/task_mgmt_v0_2.md
```
