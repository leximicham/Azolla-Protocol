...
- `docs/02_mec/schemas/yield_bundle.schema.json` (canonical v0.1 term)
- `docs/02_mec/schemas/output_bundle.schema.json` (deprecated compatibility alias; avoid in new prose)
