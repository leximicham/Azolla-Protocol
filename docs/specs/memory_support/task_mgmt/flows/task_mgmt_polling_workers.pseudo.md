...
All workers (except the Deadline Monitor Worker) use the claim/lease protocol defined in `docs/specs/patch/flows/polling_workers_v0_1.pseudo.md`.

Required claim fields are specified by `docs/specs/patch/schemas/claim_record.schema.json`.
